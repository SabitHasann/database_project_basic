...
alter table Driver add constraint pk_Driver primary key (driverLicenseNumber);
alter table Driver disable constraint pk_Driver;
alter table Driver enable constraint pk_Driver;
